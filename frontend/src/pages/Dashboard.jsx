...
const Dashboard = () => {
  ...
  const categoriesLabels = {
    ACTIF: { label: "Alumni en fonction", icon: BriefcaseIcon },
    RETRAITE: { label: "Retraité", icon: UserIcon },
    SANS_EMPLOI: { label: "Sans emploi", icon: MagnifyingGlassIcon },
    INVITE: { label: "Invité", icon: GiftIcon },
  };
                  ...
                  <div className="flex justify-between items-center py-2 border-b border-slate-100 dark:border-slate-700">
                    ...
                    <span className="flex items-center gap-2 font-medium">
                      {InscriptionCategoryIcon && (
                        <InscriptionCategoryIcon className="h-4 w-4 text-amber-600" />
                      )}
                  ...
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      ...
                      <p className="text-sm text-slate-500">
                        Tirage le {formatEventShortDate(tombolaEvent)}
                      </p>
                    </div>
                  </div>
                </div>
                  ...
                  <div className="grid grid-cols-3 gap-2">
                    {billets.slice(0, 6).map((billet) => (
                      ...
                      >
                        ...
                        <div
                          className={`flex items-center justify-center ${billet.statutPaiement === "VALIDE" ? "text-green-600" : "text-yellow-600"}`}
                        >
                          {billet.statutPaiement === "VALIDE" ? (
