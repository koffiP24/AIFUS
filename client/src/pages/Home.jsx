...
import { CalendarIcon, MapPinIcon, GiftIcon, StarIcon, UserGroupIcon } from '@heroicons/react/24/outline';
  ...
  const evenements = [
    {
      ...
      description: 'Espace d\'information, d\'orientation et de coopération entre la Côte d\'Ivoire et la Russie.',
      link: '/village',
      icon: MapPinIcon,
    ...
    },
    {
      ...
      description: 'Soirée de prestige réunissant toutes les générations d\'alumni le 1er août 2026.',
      link: '/gala',
      icon: StarIcon,
    ...
    },
    {
      ...
      description: 'Tentez de gagner une voiture et de nombreux lots ! Billets à 10 000 Fcfa.',
      link: '/tombola',
      icon: GiftIcon,
    ...
    <div className="space-y-16">
      ...
      <section className="relative overflow-hidden rounded-2xl bg-gradient-to-br from-primary-700 via-primary-800 to-slate-900 text-white">
        ...
        <div className="relative px-8 py-16 md:py-24 text-center">
          ...
          <h1 className="text-4xl md:text-6xl font-bold mb-4 tracking-tight">
            Festivités <span className="text-transparent bg-clip-text bg-gradient-to-r from-amber-300 to-amber-500">AIFUS</span> 2026
          </h1>
      ...
      <section>
        <div className="text-center mb-10">
          ...
          <p className="text-slate-600 dark:text-slate-400 max-w-2xl mx-auto">
            Trois événements exceptionnels pour celebrate notre communauté et créer de nouvelles connexions
          </p>
        </div>
        ...
        <div className="grid md:grid-cols-3 gap-8">
          {evenements.map((evenement, index) => (
            ...
            >
              ...
              <div className="p-6">
                <div className={`inline-flex items-center justify-center w-12 h-12 rounded-lg bg-gradient-to-br ${evenement.color} text-white mb-4`}>
      ...
      <section className="bg-white dark:bg-slate-800 rounded-2xl p-8 md:p-12 shadow-lg">
        <div className="grid md:grid-cols-2 gap-12 items-center">
          <div>
            <span className="text-primary-600 font-semibold text-sm uppercase tracking-wider">À propos de l'AIFUS</span>
            <h2 className="text-3xl font-bold mt-2 mb-6">Un réseau d'excellence</h2>
            ...
            <div className="relative bg-gradient-to-br from-slate-100 to-slate-200 dark:from-slate-700 dark:to-slate-800 rounded-2xl p-8 text-center">
              <div className="grid grid-cols-2 gap-6">
                <div className="p-4 bg-white dark:bg-slate-900 rounded-xl">
                  <span className="block text-3xl font-bold text-primary-600">65</span>
                  <span className="text-sm text-slate-500">Ans d'existence</span>
                </div>
                <div className="p-4 bg-white dark:bg-slate-900 rounded-xl">
                  <span className="block text-3xl font-bold text-amber-500">500+</span>
                  <span className="text-sm text-slate-500">Membres</span>
                </div>
                <div className="p-4 bg-white dark:bg-slate-900 rounded-xl">
                  <span className="block text-3xl font-bold text-purple-500">30+</span>
                  <span className="text-sm text-slate-500">Universités</span>
                </div>
                <div className="p-4 bg-white dark:bg-slate-900 rounded-xl">
                  <span className="block text-3xl font-bold text-green-500">15</span>
      ...
      <section className="relative overflow-hidden rounded-2xl bg-gradient-to-r from-amber-500 to-amber-600 text-white py-12 px-8 text-center">
        <div className="relative z-10">
          <h2 className="text-3xl font-bold mb-4">Participez aux festivités 2026</h2>
          <p className="text-amber-100 mb-6 max-w-2xl mx-auto">
            Inscrivez-vous dès maintenant pour ne pas manquer nos événements exclusifs et bénéficier d'offres spéciales.
          </p>
          <div className="flex flex-wrap justify-center gap-4">
            <Link 
              to="/register" 
